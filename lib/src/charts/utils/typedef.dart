...
typedef ChartActualRangeChangedCallback =
...
typedef ChartLabelFormatterCallback =
...
typedef ChartAxisLabelTapCallback =
...
/// Returns the offset.
typedef ChartTouchInteractionCallback =
    void Function(ChartTouchInteractionArgs tapArgs);

/// Returns the IndicatorRenderArgs.
typedef ChartIndicatorRenderCallback =
    TechnicalIndicatorRenderDetails Function(
...
typedef ChartShaderMapper<T> =
    Shader Function(T datum, int index, Color color, Rect rect);

/// Returns the widget.
typedef ChartWidgetBuilder<T, D> =
    Widget Function(
      T data,
      ChartPoint<D> point,
      ChartSeries<T, D> series,
...
/// Returns the DataLabelRenderArgs.
typedef CircularDataLabelRenderCallback =
    void Function(DataLabelRenderArgs dataLabelArgs);
...
typedef CircularSeriesRendererCreatedCallback<T, D> =
...
/// Returns the DataLabelRenderArgs.
typedef FunnelDataLabelRenderCallback =
    void Function(DataLabelRenderArgs dataLabelArgs);
...
/// Returns the offset.
typedef FunnelTouchInteractionCallback =
    void Function(ChartTouchInteractionArgs tapArgs);
...
/// Returns the DataLabelRenderArgs.
typedef PyramidDataLabelRenderCallback =
    void Function(DataLabelRenderArgs dataLabelArgs);
...
typedef PyramidSeriesRendererCreatedCallback<T, D> =
