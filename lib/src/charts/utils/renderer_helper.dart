...
Offset calculateExplodingCenter(
  double midAngle,
...
Path calculateArcPath(
  ...
  final Offset radiusStartPoint = Offset(
    radius * cos(startRadian) + center.dx,
  ...
  final bool isFullCircle =
      (endRadian - startRadian).toStringAsFixed(5) ==
...
Path calculateRoundedCornerArcPath(
  ...
  path.addArc(
    ...
    degreesToRadians(endAngle - startAngle),
  );
