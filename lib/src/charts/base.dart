      ...
      if (axis.opposedPosition) {
        ...
        if (crossing != null) {
          ...
          if (axis.isVisible && rightAxisPosition != plotAreaBounds.topRight) {
            rightAxisPosition =
                rightAxisPosition.translate(spaceBetweenMultipleAxes, 0);
          }
        ...
        if (crossing != null) {
          ...
          if (axis.isVisible && leftAxisPosition != plotAreaBounds.topLeft) {
            leftAxisPosition =
                leftAxisPosition.translate(-spaceBetweenMultipleAxes, 0);
          }
          childParentData.offset =
      ...
      if (axis.opposedPosition) {
        ...
        if (crossing != null) {
          ...
          if (axis.isVisible && topAxisPosition != plotAreaBounds.topLeft) {
            topAxisPosition =
                topAxisPosition.translate(0, -spaceBetweenMultipleAxes);
          }
          childParentData.offset =
        ...
        if (crossing != null) {
          ...
          if (axis.isVisible &&
            ...
            bottomAxisPosition =
                bottomAxisPosition.translate(0, spaceBetweenMultipleAxes);
          }
